      ...
      <div class="campania-card">
        <div class="campania-card-header">
          <div class="d-flex justify-content-between align-items-center">
            <h2 class="card-title"><i class="fas fa-plus-circle mr-2"></i>Nueva Campaña</h2>
  ...
  <div class="row">
    <div class="col-md-8">
      <div class="card campania-card">
        <div class="campania-card-header">
          <h3 class="card-title"><i class="fas fa-cog mr-2"></i>Configuración de la Campaña</h3>
        </div>
        <form action="<?= base_url('campanias/store') ?>" method="post">
          ...
          <div class="campania-card-footer">
            <button type="submit" class="btn btn-crear-campania">
    ...
    <div class="col-md-4">
      <div class="card campania-card ayuda-card">
        <div class="card-header">
          <h3 class="card-title"><i class="fas fa-lightbulb mr-2"></i>Ayuda</h3>
        </div>
